...
export function getInitialAchievements(): Achievement[] {
  return [
    ...
    },
    {
      id: "first_project",
      title: "开始学习",
      description: "创建第一个学习主题，迈出第一步",
      icon: "🚀",
      rarity: "common",
      unlocked: false,
      progress: 0,
      target: 1,
      condition: "创建 1 个学习主题",
    },
    {
      id: "first_project_complete",
      title: "路线完成",
      description: "完成第一条学习路线，见证从想学到会做的转变",
      icon: "🏁",
      rarity: "rare",
      unlocked: false,
      progress: 0,
      target: 1,
      condition: "完成 1 条学习路线",
    },
    // 连续坚持类
    {
      id: "three_days_streak",
      title: "三日连胜",
      description: "连续 3 天完成练习，习惯正在形成",
      icon: "📌",
      rarity: "common",
      unlocked: false,
      progress: 0,
      target: 3,
      condition: "连续 3 天完成练习",
    },
    {
      id: "week_streak",
      title: "一周坚持",
      description: "连续 7 天完成练习，习惯正在养成",
      icon: "🔥",
      rarity: "rare",
      unlocked: false,
      progress: 0,
      target: 7,
      condition: "连续 7 天完成练习",
    },
    {
      id: "month_streak",
      title: "月度坚持",
      description: "连续 30 天完成练习，你已经超越了大多数人",
      icon: "🌟",
      rarity: "epic",
      unlocked: false,
      progress: 0,
      target: 30,
      condition: "连续 30 天完成练习",
    },
    // 状态成就类
    {
      id: "perfect_day",
